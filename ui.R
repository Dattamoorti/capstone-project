  ...
  fluidPage(
    ...
    sidebarLayout(
      ...
      mainPanel(
        ...
        hr(),
        hr(),
        #img(src = 'E:/coursera-capstone/final/Shinyapp/Swiftkey-Logo.jpg', height = 101, width = 498),
        hr(),
        hr(),
        #img(src = 'E:/coursera-capstone/final/Shinyapp/coursera-social-logo.png', height = 122, width = 467),
        hr()
      )
    )
  )
