...
```{r, echo=TRUE, message=FALSE, warning=FALSE}
blogsURL <- file("C:/Users/Datta/Desktop/coursera-capstone/final/en_US/en_US.blogs.txt", open="rb") # open for reading in binary mode
blogs <- readLines(blogsURL, encoding = "UTF-8", skipNul=TRUE)

newsURL <- file("C:/Users/Datta/Desktop/coursera-capstone/final/en_US/en_US.news.txt", open = "rb") # open for reading in binary mode
news <- readLines(newsURL, encoding = "UTF-8", skipNul=TRUE)

twitterURL <- file("C:/Users/Datta/Desktop/coursera-capstone/final/en_US/en_US.twitter.txt", open = "rb") # open for reading in binary mode
...
```{r, echo=TRUE}
## Size of Files
file.info("C:/Users/Datta/Desktop/coursera-capstone/final/en_US/en_US.blogs.txt")$size / 1024^2 # Megabytes
file.info("C:/Users/Datta/Desktop/coursera-capstone/final/en_US/en_US.news.txt")$size  / 1024^2 # Megabytes
file.info("C:/Users/Datta/Desktop/coursera-capstone/final/en_US/en_US.twitter.txt")$size / 1024^2 # Megabytes
...
length(sampleTotal)
writeLines(sampleTotal, "C:/Users/Datta/Desktop/coursera-capstone/final/sampleTotal.txt")
```
...
textCon <- file("C:/Users/Datta/Desktop/coursera-capstone/final/sampleTotal.txt")
